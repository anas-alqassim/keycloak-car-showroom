...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "description" >
        ...
        <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
            <p class="mb-m">
                To access the data platform, please create an account 
            </p>

            <a class="pf-c-button pf-m-primary btn-lg btn-stroked"
                                                    href="${url.registrationUrl}">${msg("doRegister")}</a>
        </#if>

    <#elseif section = "form">
        <div id="kc-form">
          <h2 class="mb-m">Log in</h2>
                ...
                <form id="kc-form-login" class="${properties.kcFormClass!} onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                    ...
                    <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                        <div id="kc-form-options">
                            ...
                            <div class="mb-s mt-s ${properties.kcFormOptionsWrapperClass!}">
                      ...
                      <p class="text-small mt-s">
                        <!-- TODO add server action and localised text -->
                        By continuing, you agree to our <a class="link-underline" href="#">terms and conditions</a>
                      </p>
                </form>
            </#if>
            </div>
